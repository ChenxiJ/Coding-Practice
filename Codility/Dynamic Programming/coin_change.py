...
def min_coin_opt(coin, payment_value):
    dp = [0] + [sys.maxsize] * value
    for i in range(1, len(coin) + 1):
        for j in range(coin[i - 1], payment_value + 1):
